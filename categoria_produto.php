...
<div class="conteudo">
	...
	?>
	<div class="letra12MyriadPro" style="margin-left:10px;color:#57A7B3; clear: both; padding-top:20px;margin-top:10px; margin-bottom:10px;">
	...
	<div class="produto">
		<div class="imagem_produto">
			<a href="./uploads/fotos/g_<?php echo $imagem_imagem;?>" rel="lightbox[roadtrip]">
				<img src="./uploads/fotos/g_<?php echo $imagem_imagem;?>" alt="odonto" title="odonto" name="odonto" border="0" width="181px" height="120" />
			</a>
		</div>
