<?php	
	...
	$result=null;
	if (($_GET["id"]!=null)){
		$sql	="SELECT id,titulo,imagem,id_categoria,obs FROM foto where (id=0".$_GET["id"].")";
...
<div id="individual_cadastro">
	...
	<div id="menus_m">
		<a href="principal.php?pg=editar_foto">
	...
	<div id="relatorio_input">
		<table cellpadding= "4" cellspacing = "0" border= "1" width="900 ">
			...
			?>
				<tr>
					<td>
						<a href="principal.php?pg=cadastro_foto&id=<?php echo $row['id'];?>" VALUE="EDITAR" NAME="EDITAR">
					...
					<td>	
						<a href="../control/foto.php?acao=deletar&id=<?php echo $row['id'];?>" >
