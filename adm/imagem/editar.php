	...
	<div id="menus_m">
		...
		<form method="post" action="../control/imagem.php" enctype="multipart/form-data" name="form1" id="form1">
			...
			<table >
					...
					<tr>
					<td>Titulo:<input type="text" name="titulo" size="70" maxlength="36" value="<?php if ($result!=null) echo $row["titulo"]?>"></td>
					</tr>
						<tr>
					<td>Valor:<input type="text" name="valor" size="70"maxlength="36" value="<?php if ($result!=null) echo $row["valor"]?>"></td>
					</tr>
					<tr>
					<td>	
